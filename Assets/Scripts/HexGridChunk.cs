...
public class HexGridChunk : MonoBehaviour {
    ...
    /*
	Calling Refresh() sets enabled = true, so LateUpdate() runs
	once in the next frame, updates the mesh, and then disables
	itself. LateUpdate() is used instead of Update() to ensure
	the mesh refresh happens after all other updates in that frame.
	*/
    public void Refresh () {
		enabled = true;
	}
